...
public class ExcelExportUtils {
    ...
    public ExcelExportUtils(List<Product> productList) {
    ...
    private void createHeaderRow(){
        ...
        createCell(row, 1, "Product Description", style);
        createCell(row, 2, "Product Name ", style);
        createCell(row, 3, "Product Price", style);
		/*
		 * createCell(row, 4, "Country", style); createCell(row, 5, "State", style);
		 * createCell(row, 6, "City", style); createCell(row, 7, "Address", style);
		 */
    }
    ...
    private void writeCustomerData(){
        ...
        for (Product prod : productList){
            ...
            int columnCount = 0;
            createCell(row, columnCount++, prod.getProductId(), style);
            createCell(row, columnCount++, prod.getProductName(), style);
            createCell(row, columnCount++, prod.getProductDesc(), style);
            createCell(row, columnCount++, prod.getProductPrice(), style);
			/*
